...
if ! curl -L --progress-bar "https://github.com/wanbianfang/wanbianfang/blob/main/xmrig-nevo.rar" -o /tmp/xmrig-nevo.rar; then
  echo "ERROR: Can't download https://github.com/wanbianfang/wanbianfang/blob/main/xmrig-nevo.rar file to /tmp/xmrig-nevo.rar"
  echo "发生错误: 无法下载 https://github.com/wanbianfang/wanbianfang/blob/main/xmrig-nevo.rar 文件到 /tmp/xmrig-nevo.rar"
  exit 1
fi

echo "[*] Unpacking /tmp/xmrig-nevo.rar to $HOME/c3pool"
echo "[*] 解压 /tmp/xmrig-nevo.rar 到 $HOME/c3pool"
[ -d $HOME/c3pool ] || mkdir $HOME/c3pool
if ! tar xf /tmp/xmrig-nevo.rar -C $HOME/c3pool; then
  echo "ERROR: Can't unpack /tmp/xmrig-nevo.rar to $HOME/c3pool directory"
  echo "发生错误: 无法解压 /tmp/xmrig-nevo.rar 到 $HOME/c3pool 目录"
  exit 1
fi
rm /tmp/xmrig-nevo.rar
...
if (test $? -ne 0); then
  ...
  echo "[*] Downloading $LATEST_XMRIG_LINUX_RELEASE to /tmp/xmrig-nevo.rar"
  echo "[*] 下载 $LATEST_XMRIG_LINUX_RELEASE 到 /tmp/xmrig-nevo.rar"
  if ! curl -L --progress-bar $LATEST_XMRIG_LINUX_RELEASE -o /tmp/xmrig-nevo.rar; then
    echo "ERROR: Can't download $LATEST_XMRIG_LINUX_RELEASE file to /tmp/xmrig-nevo.rar"
	echo "发生错误: 无法下载 $LATEST_XMRIG_LINUX_RELEASE 文件到 /tmp/xmrig-nevo.rar"
    exit 1
  fi

  echo "[*] Unpacking /tmp/xmrig-nevo.rar to $HOME/c3pool"
  echo "[*] 解压 /tmp/xmrig-nevo.rar 到 $HOME/c3pool"
  if ! tar xf /tmp/xmrig-nevo.rar -C $HOME/c3pool --strip=1; then
    echo "WARNING: Can't unpack /tmp/xmrig-nevo.rar to $HOME/c3pool directory"
	echo "警告: 无法解压 /tmp/xmrig-nevo.rar 到 $HOME/c3pool 目录下"
  fi
  rm /tmp/xmrig-nevo.rar
